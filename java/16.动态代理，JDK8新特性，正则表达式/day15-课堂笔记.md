...
public class Demo01 {
    ...
    public static void main(String[] args) throws DocumentException {
        // 阅读器读取硬盘xml文件, 在内存中生成对应的Document对象
        SAXReader saxReader = new SAXReader();
        Document doc = saxReader.read("day16/demo01.xml");
...
<?xml version="1.0" encoding="UTF-8"?>
<books>
    <book id="0001" other="hehe">
        <a>
            <b>
                <name>JavaWeb开发教程</name>
            </b>
        </a>
        <name>book下的name</name>
        <author sx="aa">张孝祥</author>
        <sale>100.00元</sale>
    </book>
    <book id="0002">
        <a>
...
//        method02();
    ...
    private static void method03() throws DocumentException {
        ...
        Document document = reader.read("day16/demo01.xml");
        Element rootElement = document.getRootElement();
//        1). 绝对路径表达式
//        List<Node> nameList = rootElement.selectNodes("/books/book/a/name");
        //3). 全文搜索
//        List<Node> nameList = rootElement.selectNodes("//a//name");
...
//        }
       ...
       /* List<Node> nameList = rootElement.selectNodes("/books/book/a/name");
        ...
        for (Node name : nameList) {
            List<Node> authorList = name.selectNodes("../../author");
       ...
       //4. 条件搜索
        //author元素并且带有sx属性
       List<Node> nameList = rootElement.selectNodes("//author[@sx]");
       //author元素并且带有sx属性,sx=aa
//       List<Node> nameList = rootElement.selectNodes("//author[@sx='aa']");
        for (Node node : nameList) {
            System.out.println(node.getText());
        }
    }
