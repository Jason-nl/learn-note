...
**接口地址**:`/admin/api/v1/news_auth/auth_fail`
...
**接口地址**:`/admin/api/v1/news_auth/auth_pass`
...
**接口地址**:`/admin/api/v1/news_auth/list`
...
**接口地址**:`/admin/api/v1/news_auth/one/{id}`
...
**接口地址**:`/admin/api/v1/sensitive/del/{id}`
...
**接口地址**:`/admin/api/v1/sensitive/list`
...
**接口地址**:`/admin/api/v1/sensitive/save`
...
**接口地址**:`/admin/api/v1/sensitive/update`
...
**接口地址**:`/admin/api/v1/channel/channels`
...
**接口地址**:`/admin/api/v1/channel/del/{id}`
...
**接口地址**:`/admin/api/v1/channel/list`
...
**接口地址**:`/admin/api/v1/channel/save`
...
**接口地址**:`/admin/api/v1/channel/update`
